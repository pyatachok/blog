...
if(!function_exists('optionsframework_options')) {
	...
	function optionsframework_options() {
		...
		$options['footer_pinterest'] = array( 
							"name" => "Pinterest",
							"desc" => "Pinterest URL",
							"id" => "footer_pinterest",
							"std" => "",
...
*/
add_action( 'customize_register', 'themeXXXX_register' );

if(!function_exists('themeXXXX_register')) {

	function themeXXXX_register($wp_customize) {
		/**
		...
		/*	General
		/*-----------------------------------------------------------------------------------*/
		$wp_customize->add_section( 'themeXXXX_header', array(
			'title' => __( 'General', 'themeXXXX' ),
			'priority' => 200
		));
		
		/* Background Image*/
		$wp_customize->add_setting( 'themeXXXX[body_background][image]', array(
		...
		$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'body_background_image', array(
			...
			'section' => 'themeXXXX_header',
			'settings'   => 'themeXXXX[body_background][image]'
		) ) );
		
		
		/* Background Color*/
		$wp_customize->add_setting( 'themeXXXX[body_background][color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'body_background', array(
			...
			'section' => 'themeXXXX_header',
			'settings'   => 'themeXXXX[body_background][color]'
		) ) );
		
		/* Header Color */
		$wp_customize->add_setting( 'themeXXXX[header_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_color', array(
			...
			'section' => 'themeXXXX_header',
			'settings'   => 'themeXXXX[header_color]'
		) ) );
		
		
		/* Body Font Face */
		$wp_customize->add_setting( 'themeXXXX[google_mixed_3][face]', array(
			'default' => $options['google_mixed_3']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'themeXXXX_google_mixed_3', array(
				'label' => $options['google_mixed_3']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[google_mixed_3][face]',
				'type' => 'select',
		...
		$wp_customize->add_setting( 'themeXXXX[links_color]', array(
		...
		$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'links_color', array(
			...
			'section' => 'themeXXXX_header',
			'settings'   => 'themeXXXX[links_color]'
		) ) );
		
		/* H1 Heading font face */
		$wp_customize->add_setting( 'themeXXXX[h1_heading][face]', array(
			'default' => $options['h1_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'themeXXXX_h1_heading', array(
				'label' => $options['h1_heading']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[h1_heading][face]',
				'type' => 'select',
				'choices' => $options['h1_heading']['options']['faces']
		) );
		
		/* H2 Heading font face */
		$wp_customize->add_setting( 'themeXXXX[h2_heading][face]', array(
			'default' => $options['h2_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'themeXXXX_h2_heading', array(
				'label' => $options['h2_heading']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[h2_heading][face]',
				'type' => 'select',
				'choices' => $options['h2_heading']['options']['faces']
		) );

		/* H3 Heading font face */
		$wp_customize->add_setting( 'themeXXXX[h3_heading][face]', array(
			'default' => $options['h3_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'themeXXXX_h3_heading', array(
				'label' => $options['h3_heading']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[h3_heading][face]',
				'type' => 'select',
				'choices' => $options['h3_heading']['options']['faces']
		) );

		/* H4 Heading font face */
		$wp_customize->add_setting( 'themeXXXX[h4_heading][face]', array(
			'default' => $options['h4_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'themeXXXX_h4_heading', array(
				'label' => $options['h4_heading']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[h4_heading][face]',
				'type' => 'select',
				'choices' => $options['h4_heading']['options']['faces']
		) );

		/* H5 Heading font face */
		$wp_customize->add_setting( 'themeXXXX[h5_heading][face]', array(
			'default' => $options['h5_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'themeXXXX_h5_heading', array(
				'label' => $options['h5_heading']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[h5_heading][face]',
				'type' => 'select',
				'choices' => $options['h5_heading']['options']['faces']
		) );
		
		/* H6 Heading font face */
		$wp_customize->add_setting( 'themeXXXX[h6_heading][face]', array(
			'default' => $options['h6_heading']['std']['face'],
			'type' => 'option'
		) );
		
		$wp_customize->add_control( 'themeXXXX_h6_heading', array(
				'label' => $options['h6_heading']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[h6_heading][face]',
				'type' => 'select',
		...
		/* Search Box*/
		$wp_customize->add_setting( 'themeXXXX[g_search_box_id]', array(
				'default' => $options['g_search_box_id']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_g_search_box_id', array(
				'label' => $options['g_search_box_id']['name'],
				'section' => 'themeXXXX_header',
				'settings' => 'themeXXXX[g_search_box_id]',
		...
		$wp_customize->add_section( 'themeXXXX_logo', array(
			'title' => __( 'Logo', 'themeXXXX' ),
			'priority' => 201
		) );
		
		/* Logo Type */
		$wp_customize->add_setting( 'themeXXXX[logo_type]', array(
				'default' => $options['logo_type']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_logo_type', array(
				'label' => $options['logo_type']['name'],
				'section' => 'themeXXXX_logo',
				'settings' => 'themeXXXX[logo_type]',
				'type' => $options['logo_type']['type'],
				'choices' => $options['logo_type']['options']
		) );
		
		/* Logo Path */
		$wp_customize->add_setting( 'themeXXXX[logo_url]', array(
			'type' => 'option'
		) );
		...
		$wp_customize->add_section( 'themeXXXX_slider', array(
			'title' => __( 'Slider', 'themeXXXX' ),
			'priority' => 202
		) );
		 
		/* Slider Effect */
		$wp_customize->add_setting( 'themeXXXX[sl_effect]', array(
				'default' => $options['sl_effect']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_effect', array(
				'label' => $options['sl_effect']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_effect]',
				'type' => $options['sl_effect']['type'],
				'choices' => $options['sl_effect']['options']
		) );
		 
		/* Pause time */
		$wp_customize->add_setting( 'themeXXXX[sl_pausetime]', array(
				'default' => $options['sl_pausetime']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_pausetime', array(
				'label' => $options['sl_pausetime']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_pausetime]',
				'type' => $options['sl_pausetime']['type']
		) );
		 
		/* Animation speed */
		$wp_customize->add_setting( 'themeXXXX[sl_animation_speed]', array(
				'default' => $options['sl_animation_speed']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_animation_speed', array(
				'label' => $options['sl_animation_speed']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_animation_speed]',
				'type' => $options['sl_animation_speed']['type']
		) );
		 
		/* Auto slideshow */
		$wp_customize->add_setting( 'themeXXXX[sl_slideshow]', array(
				'default' => $options['sl_slideshow']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_slideshow', array(
				'label' => $options['sl_slideshow']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_slideshow]',
				'type' => $options['sl_slideshow']['type'],
				'choices' => $options['sl_slideshow']['options']
		) );
		 
		/* Slide thumbnails */
		$wp_customize->add_setting( 'themeXXXX[sl_thumbnails]', array(
				'default' => $options['sl_thumbnails']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_thumbnails', array(
				'label' => $options['sl_thumbnails']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_thumbnails]',
				'type' => $options['sl_thumbnails']['type'],
				'choices' => $options['sl_thumbnails']['options']
		) );
		 
		/* Show pagination? */
		$wp_customize->add_setting( 'themeXXXX[sl_control_nav]', array(
				'default' => $options['sl_control_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_control_nav', array(
				'label' => $options['sl_control_nav']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_control_nav]',
				'type' => $options['sl_control_nav']['type'],
				'choices' => $options['sl_control_nav']['options']
		) );   
		 
		/* Display next & prev navigation? */
		$wp_customize->add_setting( 'themeXXXX[sl_dir_nav]', array(
				'default' => $options['sl_dir_nav']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_dir_nav', array(
				'label' => $options['sl_dir_nav']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_dir_nav]',
				'type' => $options['sl_dir_nav']['type'],
				'choices' => $options['sl_dir_nav']['options']
		) );
		 
		/* Play/Pause button */
		$wp_customize->add_setting( 'themeXXXX[sl_play_pause_button]', array(
				'default' => $options['sl_play_pause_button']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_play_pause_button', array(
				'label' => $options['sl_play_pause_button']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_play_pause_button]',
		...
		/* Loader */
		$wp_customize->add_setting( 'themeXXXX[sl_loader]', array(
				'default' => $options['sl_loader']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_sl_loader', array(
				'label' => $options['sl_loader']['name'],
				'section' => 'themeXXXX_slider',
				'settings' => 'themeXXXX[sl_loader]',
		...
		$wp_customize->add_section( 'themeXXXX_blog', array(
				'title' => __( 'Blog', 'themeXXXX' ),
				'priority' => 203
		) );
		
		/* Blog image size */
		$wp_customize->add_setting( 'themeXXXX[post_image_size]', array(
				'default' => $options['post_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_post_image_size', array(
				'label' => $options['post_image_size']['name'],
				'section' => 'themeXXXX_blog',
				'settings' => 'themeXXXX[post_image_size]',
				'type' => $options['post_image_size']['type'],
				'choices' => $options['post_image_size']['options']
		) );
		
		/* Single post image size */
		$wp_customize->add_setting( 'themeXXXX[single_image_size]', array(
				'default' => $options['single_image_size']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_single_image_size', array(
				'label' => $options['single_image_size']['name'],
				'section' => 'themeXXXX_blog',
				'settings' => 'themeXXXX[single_image_size]',
				'type' => $options['single_image_size']['type'],
				'choices' => $options['single_image_size']['options']
		) );
		
		/* Post Meta */
		$wp_customize->add_setting( 'themeXXXX[post_meta]', array(
				'default' => $options['post_meta']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_post_meta', array(
				'label' => $options['post_meta']['name'],
				'section' => 'themeXXXX_blog',
				'settings' => 'themeXXXX[post_meta]',
				'type' => $options['post_meta']['type'],
				'choices' => $options['post_meta']['options']
		) );
		
		/* Post Excerpt */
		$wp_customize->add_setting( 'themeXXXX[post_excerpt]', array(
				'default' => $options['post_excerpt']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_post_excerpt', array(
				'label' => $options['post_excerpt']['name'],
				'section' => 'themeXXXX_blog',
				'settings' => 'themeXXXX[post_excerpt]',
		...
		$wp_customize->add_section( 'themeXXXX_footer', array(
			'title' => __( 'Footer', 'themeXXXX' ),
			'priority' => 204
		) );
			
		/* Footer Copyright Text */
		$wp_customize->add_setting( 'themeXXXX[footer_text]', array(
				'default' => $options['footer_text']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_footer_text', array(
				'label' => $options['footer_text']['name'],
				'section' => 'themeXXXX_footer',
				'settings' => 'themeXXXX[footer_text]',
				'type' => 'text'
		) );
		
		
		/* Display Footer Menu */
		$wp_customize->add_setting( 'themeXXXX[footer_menu]', array(
				'default' => $options['footer_menu']['std'],
				'type' => 'option'
		) );
		$wp_customize->add_control( 'themeXXXX_footer_menu', array(
				'label' => $options['footer_menu']['name'],
				'section' => 'themeXXXX_footer',
				'settings' => 'themeXXXX[footer_menu]',
