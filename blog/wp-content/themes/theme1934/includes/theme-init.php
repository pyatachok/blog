...
function my_post_type_slider() {
	register_post_type( 'slider',
                array( 
				'label' => __('Slides', 'themeXXXX'), 
				'singular_label' => __('Slide', 'themeXXXX'),
				'_builtin' => false,
...
function my_post_type_portfolio() {
	register_post_type( 'portfolio',
                array( 
				'label' => __('Portfolio', 'themeXXXX'), 
				'singular_label' => __('Porfolio Item', 'themeXXXX'),
				'_builtin' => false,
				'public' => true, 
				'show_ui' => true,
...
function my_post_type_testi() {
	register_post_type( 'testi',
                array( 
				'label' => __('Testimonial', 'themeXXXX'), 
				'public' => true, 
				'show_ui' => true,
				'show_in_nav_menus' => false,
				'menu_position' => 5,
...
function phi_post_type_faq() {
	register_post_type('faq', 
				array(
				'label' => __('FAQs', 'themeXXXX'),
				'singular_label' => __('FAQ', 'themeXXXX'),
				'public' => false,
				'show_ui' => true,
...
function my_post_type_team() {
	register_post_type( 'team',
                array( 
				'label' => __('Our Team', 'themeXXXX'), 
				'singular_label' => __('Person', 'themeXXXX'),
				'_builtin' => false,
				'exclude_from_search' => true, // Exclude from Search Results
				'capability_type' => 'page',
				'public' => true, 
